...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.15.0 // indirect
	go.opentelemetry.io/otel v0.15.0 // indirect
	go.opentelemetry.io/otel/exporters/metric/prometheus v0.15.0 // indirect
	go.opentelemetry.io/otel/exporters/stdout v0.15.0 // indirect
	go.opentelemetry.io/otel/exporters/trace/jaeger v0.15.0 // indirect
